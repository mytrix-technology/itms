...
class PermissionController extends BaseController
{
    ...
    */
    public function getIndex()
    {
        ...
        if(Request::ajax()) {
            $html = View::make(Config::get('views.permissions-list'), array('permissions' => $permissions))->render();

            return Response::json(array('html' => $html));
        }

        $this->layout = View::make(Config::get('views.permissions-index'), array('permissions' => $permissions));
    ...
    {
        $this->layout = View::make(Config::get('views.permission-create'));
    ...
    */
    public function getShow($permissionId)
    {
        try {
            ...
            $this->layout = View::make(Config::get('views.permission-edit'), array(
