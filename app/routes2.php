...
Route::group(array('before' => 'basicAuth', 'prefix' => Config::get('config.config.uri')), function()
{
    ...
    Route::post('email/new', array(
        'as' => 'newEmailPost',
        'uses' => 'MrJuliuss\Syntara\Controllers\DashboardController@postEmail')
    );
...
Route::group(array('before' => 'basicAuth|hasPermissions', 'prefix' => Config::get('config.config.uri')), function()
{
    ...
    /*Route::post('/weeklymeeting-grid', function()
    {
        GridEncoder::encodeRequestedData(new WeeklyMeeting(new WM()), Input::all());
    });
    ...
    Route::post('/new', function()
    {
        ...
        $EloquentWeeklyMeeting = new EloquentWeeklyMeeting();
         
        return $EloquentWeeklyMeeting->create($input);
    });
    ...
    Route::post('/edit', function()
    {
        ...
        return $EloquentWeeklyMeeting->update($id, $input);
    });
    ...
    Route::post('/delete', function()
    {
        ...
        return $EloquentWeeklyMeeting->delete(Input::json()->get('id'));
    });*/
