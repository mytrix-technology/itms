...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-warning collapsed-box">
            ...
            <div class="box-body">
                {{ Form::open(array('url' => 'masterstatuss')) }}
                <div class="col-lg-6">
                    <div class="form-group">
                        {{ Form::label('groupNameSearch', 'Group') }}
                        {{ Form::text('groupNameSearch', null, array('id' => 'groupNameSearch', 'class' => 'col-lg-12 form-control')) }}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List of Status Master</h3>
                    <p class="pull-right">
                        @if($currentUser->hasAccess('create-masterstatus'))
                        <a class="btn btn-app" href="{{ URL::route('newMasterStatus') }}">
            ...
            <div class="box-body  ajax-content no-padding">
                ...
                @endif
                @include('adminlte::master.status.list-masterstatus')
            </div>
        </div>
    </div>
</div>
