...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-warning collapsed-box">
            ...
            <div class="box-body">
                {{ Form::open(array('url' => 'mastertasktypes')) }}
                <div class="col-lg-6">
                    <div class="form-group">
                        {{ Form::label('taskTypeNameSearch', 'Name') }}
                        {{ Form::text('taskTypeNameSearch', null, array('id' => 'taskTypeNameSearch', 'class' => 'col-lg-12 form-control')) }}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List of Task Type Master</h3>
                    <p class="pull-right">
                        @if($currentUser->hasAccess('create-mastertasktype'))
                        <a class="btn btn-app" href="{{ URL::route('newMasterTaskType') }}">
            ...
            <div class="box-body  ajax-content no-padding">
                ...
                @endif
                @include('adminlte::master.task_type.list-mastertasktype')
            </div>
        </div>
    </div>
</div>
