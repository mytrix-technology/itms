        ...
        <div class="col-lg-10">
            <div class="box box-primary">
                <div class="box-header">
                    <h1 class="box-title">New Database Daily Report</h1>
                </div>
                <div class="box-body">
                    ...
                    <?php endif; ?>
                    {{ Form::open(array('url' => 'dailyBackupDB/new')) }}
                    @if(Sentry::check())
                        <div class="row-fluid">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    {{ Form::hidden('user_backup', Sentry::getUser()->id, array('class' => 'col-lg-12 form-control')) }}
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    {{ Form::hidden('status_activated', 1, array('class' => 'col-lg-12 form-control')) }}
