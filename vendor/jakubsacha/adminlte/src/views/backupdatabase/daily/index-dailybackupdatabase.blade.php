...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-warning collapsed-box">
            ...
            <div class="box-body">
                {{ Form::open(array('url' => 'dailyBackupDBs')) }}
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="span2 col-lg-6 form-control" value id="datetimepicker2" data-date-format="yyyy-mm-dd hh:ii:ss" name="datepicker2" placeholder="click here"/>
                            </div><!-- /.input group -->
                        </div>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List of Database Daily Backup</h3>
                <p class="pull-right">
                        @if($currentUser->hasAccess('create-dailyBackupDB'))
                            <a class="btn btn-app" href="{{ URL::route('newDailyBackupDB') }}">
            ...
            <div class="box-body  ajax-content no-padding">
                ...
                @endif
                @include('adminlte::backupdatabase.daily.list-dailybackupdatabase')
            </div>
        </div>
    </div>
</div>
