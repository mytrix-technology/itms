    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Tasklist Open</h3>
                <p class="pull-right">
                        @if($currentUser->hasAccess('create-task'))
                        <a class="btn btn-app" href="{{ URL::route('newTask') }}">
            ...
            <div class="box-body  ajax-content no-padding">
                ...
                @endif
                @include('adminlte::tasklist.list-tasklist')
            </div>
        </div>
    </div>
</div>
